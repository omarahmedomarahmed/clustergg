...
const GROUPS: { title: string; note?: string; keys: { key: string; label: string; long?: boolean }[] }[] = [
  ...
  // it is how a pricing page starts contradicting itself.
  {
    ...
    keys: [
      ...
      { key: "pricing.prizePool", label: "Minimum prize pool per challenge" },
      ...
      { key: "pricing.perGame", label: "Per game, per month" },
      ...
      { key: "pricing.serverSharePct", label: "Server revenue share (%)" },
