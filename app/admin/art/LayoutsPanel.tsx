...
// The Card layouts tab of /admin/art. Was /admin/cards/guide.
export default async function LayoutsPanel() {
  await requireStaff();
  ...
  return (
    <>
      <Section
        ...
        note="A layout applies to a card kind, everywhere that kind is rendered — Discord, the site's share images, the bot preview on the homepage."
      >
