// The server inbox. **MS2 — two surfaces, never merged.**
//
// A server thread never appears in the other one. They are different
...
export default async function ServerInbox() {
  const rows = await inbox(await getDb(), "server");
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">Server inbox</h1>
