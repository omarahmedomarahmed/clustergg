...
import { Empty } from "@/components/admin/kit";
...
// The Content tab of /admin/language. Was /admin/translations.
export default async function EntitiesPanel() {
  ...
  return groups.length === 0
    ? <Empty>There is no translatable content yet — no quest, planet, challenge or leaderboard exists to translate.</Empty>
