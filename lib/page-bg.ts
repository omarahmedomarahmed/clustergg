...
export const PAGE_BG_PAGES: { key: string; label: string; note: string }[] = [
  ...
  { key: "discord-bot", label: "Discord bot", note: "The 'Add ClusterBot' page server owners land on." },
  { key: "pricing", label: "Pricing (for brands)", note: "The brand-facing pricing page." },
  { key: "servers", label: "Connected servers", note: "The public server directory and the earn ladder." },
