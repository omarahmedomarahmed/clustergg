...
export const SAYS = {
  ...
  kpis: () =>
    ...
    // N3/K13 — generated by the attribution module, never typed. The clause
    // that used to sit here said "a gamer in two servers is worth half to
    // each", which was the model Sprint 5 deleted, on the public homepage,
    // beside figures that were all correctly imported.
    `${attributionShort()} An entrant who never plays lowers the score.`,
