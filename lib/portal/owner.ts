...
import { attributionShort } from "../identity/attribution.ts";
import {
  poolStatesFor,
  profileCompleteness,
...
const KPI_MEANING: Record<"entrants" | "conversion" | "activation", string> = {
  // N3/K13 — the second sentence is generated by the attribution module. It
  // used to read "a gamer who is in two servers is worth half to each", which
  // described a rule that no longer existed anywhere but in this string.
  entrants:
