...
async function marketScreen(ctx: ScreenCtx, trail: Frame[]): Promise<ScreenPayload> {
  ...
  // A "Gift one" button was here (B72.3). Gone with the feature — a trophy
  // redeems for cash, so gifting one moved real value between two accounts.
...
// `giftModal` was here. Deleted with the feature (B72.3).
