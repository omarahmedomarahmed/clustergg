...
| `tests/db/cards.mts` | **B54** | no text box carries a fixed height; every standings row leads with the in-game name on BOTH cards; Satori renders every kind without throwing | ☑ 33 |
